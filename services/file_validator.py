    ...
    def validate_filled_excel      (self, 
        ...
        for previous_error_cell in previous_error_cells:
            if previous_error_cell not in current_error_cells_info:
                validated_cell_style = copy.deepcopy(self.original_cell_style[previous_error_cell])
        ...
        wrong_cells_info={}
        for current_error_cell,(data_rule,data_example) in current_error_cells_info.items():
...
if __name__ == "__main__":
    ...
    for i in range(1,7):
        ...
        error_info,excel_=Favor.validate_filled_excel(Favor.Xio.stream_excel_to_frontend(Favor.Xattr.excel_wb))
